...
@app.route("/")
def index():
  # ---- toggle between auth.html to index.html ----
  # f = open('WebApps/public/index.html', "r")
  f = open('WebApps/public/auth.html', "r")
...
def get_file(path):
  try:
    f = open('WebApps/public/' + path, "rb" if is_binary(path) else "r")
